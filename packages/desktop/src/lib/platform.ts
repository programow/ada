...
/**
 * Permissions bluemacaw cares about. Each value matches a row the onboarding
 ...
 * fallback (Wayland blocks synthetic keystrokes, so bluemacaw can only copy
...
/**
 * Computes which permissions bluemacaw requires on the current platform.
 *
 ...
 *   isn't surprised when bluemacaw can only copy-to-clipboard.
 */
